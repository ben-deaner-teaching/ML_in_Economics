...
setwd("C:/Users/Ben/Dropbox/Documents/Teaching/MLEcon2023")
...
model %>% fit(
  ...
  epochs = 1000,    #This controls how many times the optimizer goes through the whole dataset before it finishes training
